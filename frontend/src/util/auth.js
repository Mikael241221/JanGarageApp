...
// The purpose of this code is to take a JWT token, extract its payload, decode it from Base64Url encoding, and then
//  convert the decoded payload into a JavaScript object for further use and manipulation
